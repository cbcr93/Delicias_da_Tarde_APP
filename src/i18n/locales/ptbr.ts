  ...
  PAGE: {
    ...
    REPORT: {
      ...
      GENERAL: {
        ...
        UNIT: 'Total em vendas',
        TOTAL_PRODUCTS_SALES: 'Produtos Vendidos',
        TOTAL_SALES: 'Total em vendas',
        AVERAGE_TICKETS: 'Ticket Médio',
        TOTAL_STOKE: 'Itens em Estoque',
        DATE: 'Data: ',
        AMOUT: 'Quantidade: ',
        PRICE: 'Preço: ',
      },
    ...
    SALES: {
      ...
      CONFIRM: {
        ...
        TO_REGISTER_SALES: 'Fazer outra Venda',
      ...
      REGISTER: {
        ...
        TYPE: 'Categoria:',
        PRICE: 'Preço:',
        TO_CART: 'Ir para o Venda em Andamento:',
      },
      DETAILS: {
        TEXT: 'Detalhes',
        TEXT_NAME: 'Detalhes da tela: ',
        ...
        AMOUNT: 'Quantidade em Estoque:',
        CODE: 'Codigo do Produto:',
        ADD_CART: 'Adicionar no Itens da Venda',
